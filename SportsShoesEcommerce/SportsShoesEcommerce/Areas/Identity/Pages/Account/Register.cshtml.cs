...
namespace SportsShoesEcommerce.Areas.Identity.Pages.Account
{
    public class RegisterModel : PageModel
    {
        ...
        private readonly IWebHostEnvironment _webHostEnvironment;     // <-- for file upload
        ...
        public async Task<IActionResult> OnPostAsync(string returnUrl = null)
        {
            ...
            if (ModelState.IsValid)
            {
                ...
                if (Input.ProfileImage != null && Input.ProfileImage.Length > 0)
                {
                    ...
                    {
                        ModelState.AddModelError("Input.ProfileImage", "Only image files are allowed (.jpg, .jpeg, .png, .gif, .webp).");
                        return Page();
                    }
                    ...
                    {
                        ModelState.AddModelError("Input.ProfileImage", "Image must be 2 MB or smaller.");
                        return Page();
                    }
                    ...
                    // 4) Store the web-accessible path on the user
